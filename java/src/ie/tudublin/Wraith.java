...
public class Wraith extends GameObject
{
    ...
    public void render()
    {
        ...
        // top part
        sc.rect(-halfSize,-(halfSize / 4), size * 3 / 4, halfSize / 8, halfSize);
        
        sc.line(-halfSize,-(halfSize / 4), -(size * 3/ 8), -(halfSize / 2));
        sc.line(-(size * 3/ 8), -(halfSize / 2), -(size * 5 / 16), -(halfSize / 2));
        sc.line(-(size * 5 / 16), -(halfSize / 2), -(halfSize / 2), -(halfSize / 4));

        sc.line(-(halfSize / 4), -(halfSize / 4), -(halfSize / 8), -(halfSize / 2));
        sc.line(-(halfSize / 8), -(halfSize / 2), (halfSize / 8), -(halfSize));
        sc.line((halfSize / 4), -(halfSize / 4), (halfSize / 8), -(halfSize / 2));
        sc.line((halfSize / 8), -(halfSize / 2), (halfSize / 4), -(halfSize));

        sc.line( -(halfSize / 4), -(halfSize), (halfSize / 2), -(halfSize));
        sc.line( -(halfSize / 4), -(halfSize), -(halfSize / 3), -(size * 9 / 16 ));
        sc.line( (halfSize / 2), -(halfSize), (halfSize * 2 / 3), -(size * 9 / 16 ));

        sc.line(-(halfSize / 2), -(size * 9 / 16), (halfSize * 3 / 4), -(size * 9 / 16 ));
        sc.line(-(halfSize / 2), -(size * 9 / 16), -(halfSize / 2), -(size * 10 / 16 ));
        sc.line(-(halfSize / 2), -(size * 10 / 16), -(halfSize * 2 / 3), -(size * 12 / 16 ));
        sc.line(-(halfSize * 2 / 3), -(size * 12 / 16 ), -(halfSize / 3 ), -(size * 12 / 16 ));
        sc.line(-(halfSize / 3 ), -(size * 12 / 16 ), 0 , -(size * 10 / 16 ));

        sc.line(-(halfSize / 2), -(size * 10 / 16), (halfSize / 4), -(size * 10 / 16 ));
        sc.line((halfSize / 4), -(size * 10 / 16 ), (halfSize / 4), -(size * 19 / 32 ));
        sc.line((halfSize / 4), -(size * 19 / 32 ), (halfSize / 3), -(size * 19 / 32 ));
        sc.line((halfSize / 3), -(size * 19 / 32 ), (halfSize * 2 / 3), -(size * 10 / 16 ));
        sc.line((halfSize * 2 / 3), -(size * 10 / 16 ), (halfSize * 3 / 4 ), -(size * 10 / 16 ));


        sc.line((halfSize * 3 / 4), -(size * 9 / 16), (halfSize * 3 / 4), -(size * 10 / 16 ));
        sc.arc((halfSize * 3 / 4), -(size * 19 / 32), ((size * 19 / 32) - (halfSize * 3 / 4))/2, ((size * 19 / 32) - (halfSize * 3 / 4))/2,0, 180);
        // bottom part
        sc.rect(-halfSize,halfSize / 8, size * 3 / 4, halfSize / 8, halfSize);
    ...
    public void update()
    {
        ...
        if (ellapsed >= toPass)
        {
            ...
            Missile b = new Missile(sc, spawnPoint.x, spawnPoint.y, rotation);
